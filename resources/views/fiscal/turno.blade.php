			    ...
			    <span class="navbar-toggler-icon"></span>
			  	...
			  	<div class="collapse navbar-collapse" id="navbarSupportedContent">
			    	<ul class="navbar-nav mr-auto">
			        	...
			        	<a class="nav-link" href="{{url('devolver')}}">
			        		<button class="btn btn-outline-secondary">Devolver Turno</button>
			        	</a>
			      		</li>
			      		<li class="nav-item">
                          <a href="{{url('Traerturno')}}" title="" class="btn  button button2">Traer Turno</a>
