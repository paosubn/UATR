...
<div class="col-md-12">
    ...
    <nav>
        <div class="nav nav-tabs color-nav-tab" id="nav-tab" role="tablist">
            ...
            <a class="nav-item nav-link" id="nav-investigacion-tab" data-toggle="tab" href="#nav-investigacion" role="tab" aria-controls="nav-contact" aria-selected="false">
                 <i class="fa fa-archive"></i> Investigado 
            </a>
            <a class="nav-item nav-link active" id="nav-victimas-tab" data-toggle="tab" href="#nav-victimas" role="tab" aria-controls="nav-victimas" aria-selected="false">
